...
2. `ROOT/component/<component_name>/helpers/association.php` needs to load `route.php`:
...
3. Component using Categories with associations should have the method `getCategoryAssociations` in `ROOT/component/<component_name>/helpers/association.php`. Example [here](https://github.com/joomla/joomla-cms/blob/staging/components/com_content/helpers/association.php#L33)
...
5. Component should have in back-end specific `modal_associations.php` views for the item, parallel to the edit view. Example [here](https://github.com/joomla/joomla-cms/tree/staging/administrator/components/com_content/views/article/tmpl) Another way is to have chosen fields, any other implementation will not work.
