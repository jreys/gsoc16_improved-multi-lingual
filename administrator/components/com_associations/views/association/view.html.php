...
class AssociationsViewAssociation extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::custom('reference', 'save.png', '', 'COM_ASSOCIATIONS_SAVE_REFERENCE', false);
		JToolbarHelper::custom('target', 'apply.png', '', 'COM_ASSOCIATIONS_SAVE_TARGET', false);
